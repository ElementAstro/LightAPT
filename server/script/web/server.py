...
from server.script.utils import file_utils as file_utils
from server.script.utils import tornado_utils, os_utils, env_utils, custom_json
from server.script.utils.audit_utils import get_audit_name_from_request
from server.script.utils.exceptions.missing_arg_exception import MissingArgumentException
from server.script.utils.exceptions.not_found_exception import NotFoundException
from server.script.utils.tornado_utils import respond_error, redirect_relative, get_form_file
...
def init(server_config: ServerConfig,
    ...
    handlers.append((r"/(.*)", AuthorizedStaticFileHandler, {"path": "server/script/webpage"}))
